...
public class insert_delivery_data extends HttpServlet {
	 /**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				String take_delivery_date = request.getParameter("take_delivery_date");
				String delivery_amount = request.getParameter("delivery_amount");
				String creater = request.getParameter("creater");
				String createtime = request.getParameter("createtime");
				i = initialization.insert_take_delivery_data(take_delivery_order_number, allocate_order_number, boat_number, take_delivery_date, delivery_amount, creater, createtime);
